      ...
      <ul>
        {artists.map(artist => (
          <li key={artist.id}>
            ...
            <button onClick={() => {
              setArtists(
                artists.filter(a =>  //take every artist(a) here 
                  a.id !== artist.id

//Here, artists.filter(a => a.id !== artist.id) means “create an array that
// consists of those artists whose IDs are different from artist.id”.
